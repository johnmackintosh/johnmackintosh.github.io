...
If you want really concise and powerful R code, which is even more 'SQL like', then you should look at [data.table](https://cran.r-project.org/web/packages/data.table/).
