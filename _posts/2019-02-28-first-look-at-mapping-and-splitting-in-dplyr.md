...
At this point, I can see group\_map being pretty useful, but I will need to do a bit more work on the use case for group_split - at present, I'm not seeing what it offers over and above group_by, for staying in a purely dplyr workflow.
I understand if you want to throw some purrr into the mix, it becomes more useful.
As always, feel free to chip in if you have any thoughts or answers..I will try to play around with this more as well.
